        ...
        if case():
            ...
            if numPipes != 0:
                ...
                if os.path.isfile(path):
                    ...
                    if ">" in command:
                        print command.split(">") 
                        fd = os.open(commands[3], os.O_WRONLY | os.O_TRUNC | os.O_SYNC | os.O_CREAT, 0666)
                        os.dup2(fd, NEW_STDOUT)
                        comg = command.split(">")
                        execute(comg[0])
                    elif "<" in command:
                        print "here"
            ...
            if numPipes != 0:
                ...
                for i in range(0, numPipes):
                    ...
                    if pid:
                        ...
                        w = os.fdopen(w, 'w')
                        print "child: writing"
                        w.write("here is some text from the child")
                        w.close()
                        print "child: closing"
                        sys.exit(0)
